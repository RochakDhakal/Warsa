...
?>
<!-- wp:group {"metadata":{"patternName":"warsa/editor-choice","name":"Editor's Choice","categories":["warsa-post"]},"style":{"spacing":{"margin":{"top":"0","bottom":"0"},"blockGap":"0","padding":{"right":"24px","left":"24px","top":"40px","bottom":"40px"}}},"layout":{"type":"constrained","contentSize":"1260px"}} -->
...
<h2 class="wp-block-heading has-inter-font-family has-medium-font-size" style="border-top-color:var(--wp--preset--color--heading-color);border-top-width:1px;border-right-style:none;border-right-width:0px;border-bottom-style:none;border-bottom-width:0px;border-left-style:none;border-left-width:0px;padding-top:20px">Editor's Choice</h2>
<!-- /wp:heading -->
