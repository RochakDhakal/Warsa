<?php
function warsa_get_premium_status()
{
...
function warsa_get_theme_initial($name)
{
...
function warsa_get_dashboard_pages_order(): array
{
	$pages_dir = WARSA_DIR . 'inc/admin/pages';
...
$theme_initial = warsa_get_theme_initial($theme_name);

$pages_order = warsa_get_dashboard_pages_order();
...
?>
<div class="dashboard-about-warsa">
	<div class="warsa-about-header">
		<p id="warsa-initial">
			<?php
			printf(
		...
		<p id="warsa-version">
			<?php
			esc_html_e('Version ', 'warsa');
			echo esc_html($theme_version);

			if (warsa_get_premium_status()) :
			?>
				<svg id="warsa-premium-crown" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="warsa-about-body">
		...
		<div id="warsa-content">
			...
			<?php
					...
					echo esc_html__('File does not exist or is not readable.', 'warsa');
				}
			}
			?>
		</div>
